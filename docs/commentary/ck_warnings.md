...
**Code:** `asset_convert/character/modify_body_meshes.py`, `tes5_import/base/constants.py`, `tes5_import/dialogue/converter.py`, `tes5_import/dialogue/speak_as.py`
...
deliberate ([constants.py:38](../../tes5_import/base/constants.py#L38) maps TES4 Lower
